          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                        <a href="<?= base_url('par_yoshinoya');?>" class="menu-link" id ="child">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="<?= base_url('kontaminasi_benda_asing');?>" class="menu-link">
                    <div data-i18n="Vertical Form">Kontaminasi Benda Asing</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?= base_url('pspsiqf');?>" class="menu-link">
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="<?= base_url('retained_sample_report');?>" class="menu-link">
                    <div data-i18n="Vertical Form">Retained Sample Report</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?= base_url('laboratory_sample');?>" class="menu-link">
                ...
                <li class="menu-item">
                  <a href="<?= base_url('suhu_cold_storage');?>" class="menu-link">
