    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('monitoring_repack/tambah') ?>" class="btn btn-primary">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('monitoring_repackTable');
        ...
        <div class="card">
            ...
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Data Monitoring Proses Repack</h5>
                <div class="table-responsive text-nowrap">
                    <table class="table" id="monitoring_repackTable">
                        <thead>
                            <tr>
                                <th>Select</th>
                                <th>No</th>
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($monitoring_repack as $val) {
                                ?>
                                <tr>
                                    <td>
                                    ...
                                    <td><?= $val->catatan; ?></td>
                                    <td>
                                        <a href="<?= base_url('monitoring_repack/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('monitoring_repack/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('monitoring_repack/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    ...
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("monitoring_repack/print_multiple_excel"); ?>';
