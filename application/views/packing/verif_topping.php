...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Packing /</span>Verifikasi Gramasi Toping</h4>
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('verif_topping/tambah') ?>" class="btn btn-primary">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('verif_toppingTable');
        ...
        <div class="card">
            ...
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Data Kontaminasi Benda Asing</h5>
                <div class="table-responsive text-nowrap">
                    <table class="table" id="verif_toppingTable">
                        <thead>
                            <tr>
                                <th>Select</th>
                                <th>No</th>
                        ...
                        <tbody>
                            ...
                            foreach ($verif_topping as $val) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $val->p_gramasi; ?></td>
                                    <td><?= $val->pp_pukul; ?></td>
                                    <td><?= $val->pp_gramasi; ?></td>
                                    <td><?= $val->tindakan; ?></td>
                                    <td><?= $val->catatan; ?></td>

                                    <td>
                                        <a href="<?= base_url('verif_topping/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('verif_topping/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('verif_topping/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    ...
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("verif_topping/print_multiple_excel"); ?>';
