    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('pem_metal_detector/tambah') ?>" class="btn btn-primary">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('pem_metal_detectorTable');
        ...
        <div class="card">
            ...
            <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table" id="pem_metal_detectorTable">
                        <thead>
                            <tr>
                                <th>Select</th>
                                <th>No</th>
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($pem_metal_detector as $val) {
                                ?>
                                <tr>
                                    <td>
                                    ...
                                    <td><?= $val->catatan; ?></td>
                                    <td>
                                        <a href="<?= base_url('pem_metal_detector/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('pem_metal_detector/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('pem_metal_detector/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    ...
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("pem_metal_detector/print_multiple_excel"); ?>';
