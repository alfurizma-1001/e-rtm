...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Packing /</span>Verifikasi Pengemasan</h4>
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('verif_pengemasan/tambah') ?>" class="btn btn-primary">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('verif_pengemasanTable');
        ...
        <div class="card">
            ...
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Data Verifikasi Pengemasan</h5>
                <div class="table-responsive text-nowrap">
                    <table class="table" id="verif_pengemasanTable">
                        <thead>
                            <tr>
                                <th>Select</th>
                                <th>No</th>
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($verif_pengemasan as $val) {
                                ?>
                                <tr>
                                    <td>
                                    ...
                                    <td><?= $val->shift; ?></td>
                                    <td><?= $val->jam; ?></td>
                                    <td><?= $val->tnama_produk; ?></td>
                                    <td><?= $val->tprod_code; ?></td>
                                    <td><?= $val->tbb; ?></td>
                                    <td><?= $val->tqr_code; ?></td>
                                    <td><?= $val->tok_tdk; ?></td>
                                    <td><?= $val->bnama_produk; ?></td>
                                    <td><?= $val->bprod_code; ?></td>
                                    <td><?= $val->bbb; ?></td>
                                    <td><?= $val->bisi; ?></td>
                                    <td><?= $val->bok_tdk; ?></td>
                                    ...
                                    <td>
                                        <a href="<?= base_url('verif_pengemasan/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('verif_pengemasan/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('verif_pengemasan/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    ...
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("verif_pengemasan/print_multiple_excel"); ?>';
