...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Packing /</span> Monitoring Proses Repack</h4>
        <div class="card">
            <h5 class="card-header">Tambah</h5>
            <div class="card-body">
                <form action="<?= base_url('monitoring_repack/tambah') ?>" method="post">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="karton" class="form-label">Karton</label>
                                <input type="text" class="form-control" id="karton" name="karton"
                                    placeholder="Masukkan Karton" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="exp_date" name="exp_date"
                                    placeholder="Masukkan Exp Date" required>
                            </div>

                            <div class="mb-3">
                                <label for="kodefikasi" class="form-label">Kodefikasi</label>
                                <input type="text" class="form-control" id="kodefikasi" name="kodefikasi"
                                    placeholder="Masukkan Kodefikasi" required>
                            </div>

                            <div class="mb-3">
                                <label for="content" class="form-label">Content</label>
                                <input type="text" class="form-control" id="content" name="content"
                                    placeholder="Masukkan Content" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label for="kerapihan" class="form-label">Kerapihan</label>
                                <input type="text" class="form-control" id="kerapihan" name="kerapihan"
                                    placeholder="Masukkan Kerapihan" required>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <a href="<?= base_url('monitoring_repack') ?>" class="btn btn-danger"><i class="bx bx-x"></i>
                            Batal</a>
                    </div>
                </form>
            </div>
