    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('pem_xray/tambah') ?>" class="btn btn-primary">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('pem_xrayTable');
        ...
        <div class="card">
            ...
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Data Pemeriksaan X-Ray</h5>
                <div class="table-responsive text-nowrap">
                    <table class="table" id="pem_xrayTable">
                        <thead>
                            <tr>
                                <th>Select</th>
                                <th>No</th>
                        ...
                        <tbody>
                            ...
                            foreach ($pem_xray as $val) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $val->glass_ball_1; ?></td>
                                    <td><?= $val->glass_ball_2; ?></td>
                                    <td><?= $val->ceramic_1; ?></td>
                                    <td><?= $val->ceramic_2; ?></td>
                                    <td><?= $val->sus_wire_1; ?></td>
                                    <td><?= $val->sus_wire_2; ?></td>
                                    <td><?= $val->sus_ball_1; ?></td>
                                    <td><?= $val->sus_ball_2; ?></td>
                                    <td><?= $val->keterangan; ?></td>
                                    <td><?= $val->tindakan; ?></td>
                                    <td><?= $val->catatan; ?></td>
                                    <td>
                                        <a href="<?= base_url('pem_xray/edit/' . $val->uuid); ?>" class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('pem_xray/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('pem_xray/hapus/' . $val->uuid); ?>" class="btn btn-danger"
                ...
                <script>
                    ...
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("pem_xray/print_multiple_excel"); ?>';
