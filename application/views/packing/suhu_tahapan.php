...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Packing /</span>Pengecekan Suhu Produk Setiap
            Tahapan</h4>
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('suhu_tahapan/tambah') ?>" class="btn btn-primary">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('suhu_tahapanTable');
        ...
        <div class="card">
            ...
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Data Pengecekan Suhu Produk Setiap Tahapan</h5>
                <div class="table-responsive text-nowrap">
                    <table class="table" id="suhu_tahapanTable">
                        <thead>
                            <tr>
                                <th>Select</th>
                                <th>No</th>
                        ...
                        <tbody>
                            ...
                            foreach ($suhu_tahapan as $val) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $val->filling_portioning; ?></td>
                                    <td><?= $val->iqf; ?></td>
                                    <td><?= $val->top_sealer; ?></td>
                                    <td><?= $val->x_ray; ?></td>
                                    <td><?= $val->sticker; ?></td>
                                    <td><?= $val->shrink; ?></td>
                                    <td><?= $val->packing_box; ?></td>
                                    <td><?= $val->cold_storage; ?></td>
                                    <td><?= $val->filling; ?></td>
                                    <td><?= $val->masuk_iqf; ?></td>
                                    <td><?= $val->keluar_aktual; ?></td>
                                    <td><?= $val->suhu_top_sealer; ?></td>
                                    <td><?= $val->suhu_x_ray; ?></td>
                                    <td><?= $val->suhu_sticker; ?></td>
                                    <td><?= $val->suhu_shrink; ?></td>
                                    <td><?= $val->down_time; ?></td>
                                    <td><?= $val->cold_aktual; ?></td>
                                    <td><?= $val->catatan_kanan; ?></td>
                                    <td><?= $val->catatan; ?></td>
                                    <td>
                                        <a href="<?= base_url('suhu_tahapan/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('suhu_tahapan/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('suhu_tahapan/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    ...
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("suhu_tahapan/print_multiple_excel"); ?>';
