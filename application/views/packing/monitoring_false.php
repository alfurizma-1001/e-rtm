    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('monitoring_false/tambah') ?>" class="btn btn-primary">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('monitoring_falseTable');
        ...
        <div class="card">
            ...
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Data Monitoring False Rejection</h5>
                <div class="table-responsive text-nowrap">
                    <table class="table" id="monitoring_falseTable">
                        <thead>
                            <tr>
                                <th>Select</th>
                                <th>No</th>
                                ...
                                <th>Nama Produk</th>
                                <th>Kode Produksi</th>
                                <th>Jumlah Pack Tidak Lolos</th>
                                <th>Jumlah Pack Kontaminan</th>
                                <th>Jenis Kontaminan</th>
                                <th>Posisi Kontaminan</th>
                                <th>False Rejections</th>
                                <th>Catatan</th>
                                <th>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($monitoring_false as $val) {
                                ?>
                                <tr>
                                    <td>
                                    ...
                                    <td><?= $val->jumlah_pack_tdklolos; ?></td>
                                    <td><?= $val->jumlah_pack_kontaminan; ?></td>
                                    <td><?= $val->jenis_kontaminan; ?></td>
                                    <td><?= $val->posisi_kontaminan; ?></td>
                                    <td><?= $val->false_rejections; ?></td>
                                    <td><?= $val->catatan; ?></td>
                                    <td>
                                        <a href="<?= base_url('monitoring_false/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('monitoring_false/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('monitoring_false/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    ...
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("monitoring_false/print_multiple_excel"); ?>';
