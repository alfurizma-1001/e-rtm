    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('kontaminasi_benda_asing/tambah') ?>" class="btn btn-primary">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('kontaminasiTable');
        ...
        <div class="card">
            ...
            <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table" id="kontaminasiTable">
                        <thead>
                            <tr>
                                <th>Select</th>
                                <th>No</th>
                                ...
                                <th>Shift</th>
                                <th>Pukul</th>
                                <th>Jenis Kontaminasi Benda Asing</th>
                                <th>Bukti</th>
                                <th>Produk</th>
                                <th>Kode Produksi</th>
                                <th>Tahapaan</th>
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($kontaminasi_benda_asing as $val) {
                                ?>
                                <tr>
                                    <td>
                                    ...
                                    <td><?= $val->shift; ?></td>
                                    <td><?= $val->pukul; ?></td>
                                    <td><?= $val->jenis_kontaminasi_benda_asing; ?></td>
                                    <td><?= $val->bukti ?></td>
                                    <td><?= $val->produk ?></td>
                                    ...
                                    <td><?= $val->catatan; ?></td>
                                    <td>
                                        <a href="<?= base_url('kontaminasi_benda_asing/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('kontaminasi_benda_asing/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('kontaminasi_benda_asing/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    ...
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("kontaminasi_benda_asing/print_multiple_excel"); ?>';
