...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Suhu /</span>Suhu Ruangan</h4>
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('suhu_ruangan/tambah') ?>" class="btn btn-primary">
        ...
        <div class="card">
            ...
            <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table" id="suhuTable">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            foreach ($suhu_ruangan as $val) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url('suhu_ruangan/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                      
                                        <a href="<?= base_url('suhu_ruangan/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    ...
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("suhu_ruangan/print_multiple_excel"); ?>';
