...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Warehouse /</span>Pemeriksaan Dry Store</h4>
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('pemeriksaan_dry_store/tambah') ?>" class="btn btn-primary">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('pemeriksaan_dry_storeTable');
        ...
        <div class="card">
            ...
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Data Pemeriksaan Dry Store</h5>
                <div class="table-responsive text-nowrap">
                    <table class="table" id="pemeriksaan_dry_storeTable">
                        <thead>
                            <tr>
                                <th>Select</th>
                                <th>No</th>
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($pemeriksaan_dry_store as $val) {
                                ?>
                                <tr>
                                    <td>
                                    ...
                                    <td><?= $val->mobil; ?></td>
                                    <td><?= $val->no_polisi; ?></td>
                                    <td><?= $val->identitas_pengantar; ?></td>
                                    <td><?= $val->segel; ?></td>
                                    <td><?= $val->kebersihaan; ?></td>
                                    <td><?= $val->hama; ?></td>
                                    <td><?= $val->jam_masuk; ?></td>
                                    <td><?= $val->jam_keluar; ?></td>
                                    <td><?= $val->mulai_dicek; ?></td>
                                    <td><?= $val->selesai_dicek; ?></td>
                                    <td><?= $val->keterangan; ?></td>
                                    <td><?= $val->catatan; ?></td>
                                    <td>
                                        <a href="<?= base_url('pemeriksaan_dry_store/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('pemeriksaan_dry_store/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('pemeriksaan_dry_store/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    ...
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("pemeriksaan_dry_store/print_multiple_excel"); ?>';
