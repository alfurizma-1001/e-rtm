...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('sample_bulanan_rnd/tambah') ?>" method="post">
                    <div class="row">
                        <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="sample_bulan" name="sample_bulan"
                                    placeholder="Enter Sample Bulan" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="sample_storage_frozen" name="sample_storage_frozen"
                                    placeholder="Enter sample_storage_frozen" required>
                            </div>
                            <div class="mb-3">
                                <label for="sample_storage_chilled" class="form-label">Sample Storage Chilled</label>
                                <input type="text" class="form-control" id="sample_storage_chilled" name="sample_storage_chilled"
                                    placeholder="Enter sample_storage_chilled" required>
                            </div>
                            <div class="mb-3">
                                <label for="sample_storage_other" class="form-label">Sample Storage Other</label>
                                <input type="text" class="form-control" id="sample_storage_other" name="sample_storage_other"
                                    placeholder="Enter sample_storage_other" required>
                            </div>
                            <div class="mb-3">
                                <label for="nama_produk" class="form-label">Nama Produk</label>
                                <input type="text" class="form-control" id="nama_produk" name="nama_produk"
                                    placeholder="Enter nama_produk" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="best_before" name="best_before"
                                    placeholder="Enter Best Before Date" required>
                    ...
                    <div class="mb-3">
                        ...
                        <a href="<?= base_url('sample_bulanan_rnd') ?>" class="btn btn-danger"><i class="bx bx-x"></i>
                            Batal</a>
                    </div>
                </form>
            </div>
