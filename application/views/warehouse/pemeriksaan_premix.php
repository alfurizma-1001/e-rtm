    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('pemeriksaan_premix/tambah') ?>" class="btn btn-primary">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('pemeriksaan_premixTable');
        ...
        <div class="card">
            ...
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Data Pemeriksaan Kedatangan Premix</h5>
                <div class="table-responsive text-nowrap">
                    <table class="table" id="pemeriksaan_premixTable">
                        <thead>
                            <tr>
                                <th>Select</th>
                                <th>No</th>
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($pemeriksaan_premix as $val) {
                                ?>
                                <tr>
                                    <td>
                                    ...
                                    <td><?= $val->jumlah_sample_cek; ?></td>
                                    <td><?= $val->sesuai; ?></td>
                                    <td><?= $val->tidak_Sesuai; ?></td>
                                    <td><?= $val->berat_premix; ?></td>
                                    <td><?= $val->kemasan; ?></td>
                                    <td><?= $val->warna; ?></td>
                                    <td><?= $val->jamur; ?></td>
                                    <td><?= $val->aroma; ?></td>
                                    ...
                                    <td>
                                        <a href="<?= base_url('pemeriksaan_premix/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('pemeriksaan_premix/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('pemeriksaan_premix/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    ...
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("pemeriksaan_premix/print_multiple_excel"); ?>';
