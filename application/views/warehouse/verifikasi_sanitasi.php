...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Warehouse /</span>Pemeriksaan Pemasakan Rice
            Cooker</h4>
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('verifikasi_sanitasi/tambah') ?>" class="btn btn-primary">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('verifikasi_sanitasiTable');
        ...
        <div class="card">
            ...
            <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table" id="verifikasi_sanitasiTable">
                        <thead>
                            <tr>
                                <th>Select</th>
                                <th>No</th>
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($verifikasi_sanitasi as $val) {
                                ?>
                                <tr>
                                    <td>
                                    ...
                                    <td><?= $val->area; ?></td>
                                    <td><?= $val->mesin; ?></td>
                                    <td><?= $val->cleaning_agents; ?></td>
                                    <td><?= $val->keterangan; ?></td>
                                    <td><?= $val->catatan; ?></td>
                                    <td>
                                        <a href="<?= base_url('verifikasi_sanitasi/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('verifikasi_sanitasi/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('verifikasi_sanitasi/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    ...
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("verifikasi_sanitasi/print_multiple_excel"); ?>';
