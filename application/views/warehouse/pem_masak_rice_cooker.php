...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Warehouse /</span>Pemeriksaan Pemasakan Rice Cooker</h4>
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('pem_masak_rice_cooker/tambah') ?>" class="btn btn-primary">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('pem_masak_rice_cookerTable');
        ...
        <div class="card">
            ...
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Data Pemeriksaan Pemasakan Rice Cooker</h5>
                <div class="table-responsive text-nowrap">
                    <table class="table" id="pem_masak_rice_cookerTable">
                        <thead>
                            <tr>
                                <th>Select</th>
                                <th>No</th>
                                ...
                                <th>Waktu</th>
                                <th>Suhu Produk</th>
                                <th>Suhu Produk (1 Menit)</th>
                                <th>Suhu After Vakum</th>
                                <th>Jam Mulai</th>
                                <th>Jam Selesai</th>
                                <th>Kematangan</th>
                                <th>Rasa</th>
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($pem_masak_rice_cooker as $val) {
                                ?>
                                <tr>
                                    <td>
                                    ...
                                    <td><?= $val->suhu_produk_1menit; ?></td>
                                    <td><?= $val->suhu_aftervakum; ?></td>
                                    <td><?= $val->jam_mulai; ?></td>
                                    <td><?= $val->jam_selesi; ?></td>
                                    <td><?= $val->kematangan; ?></td>
                                    <td><?= $val->rasa; ?></td>
                                    <td><?= $val->aroma; ?></td>
                                    <td><?= $val->tekstur; ?></td>
                                    <td><?= $val->warna; ?></td>
                                    ...
                                    <td><?= $val->catatan; ?></td>
                                    <td>
                                        <a href="<?= base_url('pem_masak_rice_cooker/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('pem_masak_rice_cooker/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('pem_masak_rice_cooker/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    ...
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("pem_masak_rice_cooker/print_multiple_excel"); ?>';
