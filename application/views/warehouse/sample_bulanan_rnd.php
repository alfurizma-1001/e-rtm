    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('sample_bulanan_rnd/tambah') ?>" class="btn btn-primary">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('sample_bulanan_rndTable');
        ...
        <div class="card">
            ...
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Data Sample Bulanan RND</h5>
                <div class="table-responsive text-nowrap">
                    <table class="table" id="sample_bulanan_rndTable">
                        <thead>
                            <tr>
                                <th>Select</th>
                                <th>No</th>
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($sample_bulanan_rnd as $val) {
                                ?>
                                <tr>
                                    <td>
                                    ...
                                    <td><?= $val->catatan; ?></td>
                                    <td>
                                        <a href="<?= base_url('sample_bulanan_rnd/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('sample_bulanan_rnd/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('sample_bulanan_rnd/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    ...
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("sample_bulanan_rnd/print_multiple_excel"); ?>';
