...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Warehouse /</span>Suhu Cold Storage</h4>
        <div class="demo-inline-spacing">
            <div class="d-flex align-items-center justify-content-between">
                <a href="<?= base_url('suhu_cold_storage/tambah') ?>" class="btn btn-primary">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('suhu_cold_storageTable');
        ...
        <div class="card">
            ...
            <!-- Responsive Table -->
            <div class="card">
                <h5 class="card-header">Data Suhu Cold Storage</h5>
                <div class="table-responsive text-nowrap">
                    <table class="table" id="suhu_cold_storageTable">
                        <thead>
                            <tr>
                                <th>Select</th>
                                <th>No</th>
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            foreach ($suhu_cold_storage as $val) {
                                ?>
                                <tr>
                                    <td>
                                    ...
                                    <td><?= $val->suhu_cs; ?></td>
                                    <td><?= $val->suhu_dics1; ?></td>
                                    <td><?= $val->suhu_dics2; ?></td>
                                    <td><?= $val->suhu_dics3; ?></td>
                                    <td><?= $val->suhu_dics4; ?></td>
                                    <td><?= $val->suhu_dics5; ?></td>
                                    <td><?= $val->rata; ?></td>
                                    <td><?= $val->keterangan; ?></td>
                                    <td><?= $val->catatan; ?></td>
                                    <td>
                                        <a href="<?= base_url('suhu_cold_storage/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('suhu_cold_storage/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('suhu_cold_storage/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    ...
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("suhu_cold_storage/print_multiple_excel"); ?>';
