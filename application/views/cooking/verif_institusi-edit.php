                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="shift" name="shift" value="<?= $verif_institusi->shift ?>">
                            </div>
                            <div class="mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="ket" name="ket" value="<?= $verif_institusi->ket ?>">
                            </div>
                            <div class="mb-3">
