            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('verifpremixTable');
        ...
        <div class="card">
            ...
            <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table" id="verifpremixTable">
                        <thead>
                            <tr>
                            ...
                            foreach ($verif_premix as $val) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('verif_premix/edit/' . $val->uuid); ?>"
                                            class="btn btn-warning">
                                            <i class="bx bx-edit"></i> Edit
                                        </a>
                                        <a href="<?= base_url('verif_premix/print_excel/' . $val->uuid); ?>"
                                            class="btn btn-info" target="_blank">
                                            <i class="bx bx-printer"></i> Print Excel
                                        </a>
                                        <a href="<?= base_url('verif_premix/hapus/' . $val->uuid); ?>"
                ...
                <script>
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("verif_premix/print_multiple_excel"); ?>';
