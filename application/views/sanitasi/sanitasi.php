            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <script>
                    document.getElementById('tanggal').addEventListener('input', function () {
                        ...
                        const table = document.getElementById('sanitasiTable');
        ...
        <div class="card">
            ...
            <div class="card">
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table" id="sanitasiTable">
                        <thead>
                            <tr>
                            ...
                            foreach ($sanitasi as $val) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('sanitasi/hapus/' . $val->uuid); ?>" class="btn btn-danger"
                ...
                <script>
                    ...
                    function downloadMultipleExcel() {
                        ...
                        let baseUrl = '<?php echo site_url("sanitasi/print_multiple_excel"); ?>';
